...
**iSearch** is a Yelp search app using the [Yelp API](http://www.yelp.com/developers/documentation/v2/search_api).
...
![Video Walkthrough](http://i.imgur.com/eSiG05w.gif)
